...
// Source file: https://raw.githubusercontent.com/gedcom7code/js-gedcom/main/g7structure.js
// Upstream license: dual MIT + UNLICENSE, see LICENSE-MIT / LICENSE-UNLICENSE in this directory (copied verbatim).
// Upstream SHA-256 of the pristine file (before this comment was prepended): fba366b23b9fe7b8c7d1b0a46dbcf568dab0cb33cfec0a818a1f981a2517f73c
// Adaptation for Stemmagraph: NONE at the code level. The file is already native ESM, so it works as-is in Vite and in Node ESM. The only local change is this prepended provenance comment. Known upstream quirks, kept as-is: G7Dataset.fromString(str, lookup) dereferences an undefined variable named src, so callers should parse with GEDCStruct.fromString then G7Dataset.fromGEDC instead (that is what our verify script does). See README.md in this directory.
